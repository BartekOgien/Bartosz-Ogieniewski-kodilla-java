...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://bartekogien.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        WebDriver driverTrelllo = WebDriverConfig.getDriver(WebDriverConfig.CHROME);
        driverTrelllo.get(TRELLO_URL);

        driverTrelllo.findElement(By.id("user")).sendKeys("bartekogien2106@wp.pl");
        driverTrelllo.findElement(By.id("password")).sendKeys("banub526");
        ...
        result = driverTrelllo.findElements(By.xpath("//span")).stream()
