...
public class BookDirectoryTestSuite {
    ...
    public void testlistBooksInHandsOf() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser libraryUser0 = new LibraryUser("FirstName", "LastName", "pesel");
        LibraryUser libraryUser1 = new LibraryUser("FirstName1", "LastName1", "pesel1");
        LibraryUser libraryUser5 = new LibraryUser("FirstName2", "LastName2", "pesel2");
